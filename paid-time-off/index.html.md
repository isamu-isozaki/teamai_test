...
If you are taking Parental Leave, please see our [Parental Leave Policy](https://github.com/isamu-isozaki/teamai_test/tree/master/benefits/#parental-leave/index.html.md).
...
1. Working hours are flexible, you are invited to the [company call](https://github.com/isamu-isozaki/teamai_test/tree/master/communication/#company-call/index.html.md) if you are available, but it isn't mandatory and you shouldn't attend if it is during your time off.
...
1. GitLab also encourages you to use your leave for Jury Duty, bereavement leave, or to vote. You are not expected to work during this time off, but we recommend using the [Communication Guidelines](https://about.gitlab.comhttps://github.com/isamu-isozaki/teamai_test/tree/master/paid-time-off/#communicating-your-time-off/index.html.md) when these situations arise.
...
1. Please see the [On-Call](https://github.com/isamu-isozaki/teamai_test/tree/master/on-call/index.html.md/index.html.md) page for information on how to handle scheduled leave for someone from the On-Call team.
