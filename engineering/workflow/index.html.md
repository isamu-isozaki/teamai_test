...
1. [Double link](/handbook/communication/#everything-starts-with-an-issue) the issue to the merge request on dev, and the merge request on dev to the issue.
...
If you've built feature flags into your code, be sure to read about [how to use the feature flag to test a feature on GitLab.com](/handbook/engineering/infrastructure/#feature-flags).
...
Several minutes before the scheduled meeting time, follow the [livestreaming instructions](../../communication/index.html.md#live-streaming) to start a Google Hangout using the `Now` setting. Paste the Google Hangout invite link in the Google doc.
