...
Here at GitLab, iteration means making the [smallest thing possible and getting it out as quickly as possible](https://github.com/isamu-isozaki/teamai_test/tree/master/values/#iteration/index.html.md). Working like this allows us to reduce cycle time and get feedback from users faster so we can continue to improve quickly and efficiently.

Iteration isn't just one of GitLab’s six founding values, [C.R.E.D.I.T](https://github.com/isamu-isozaki/teamai_test/tree/master/values/#credit/index.html.md), it is one of the [foundational concepts in design thinking and user experience](https://www.interaction-design.org/literature/article/design-iteration-brings-powerful-results-so-do-it-again-designer/index.html.md). Planning too far ahead without real-world feedback can cause you to build something that doesn't meet users needs.
...
* We aggressively break issues down into the smallest scope possible. If an effort is too big to be completed in one milestone, then it is too big. [Epics](https://github.com/isamu-isozaki/teamai_test/tree/master/product/#how-to-use-epics/index.html.md) allow us to maintain a holistic view of an area while breaking the work down into an MVC. 
* We keep a list of improvement issues that are actively seeking contributions from the community. They are small in scope, allowing the community to contribute designs or code to the issues. You can learn more about in the [Community Contributions](https://github.com/isamu-isozaki/teamai_test/tree/master/engineering/ux/ux-department-workflow/#community-contributions/index.html.md) section of this handbook. You can also [view the list of issues that need UX work](https://gitlab.com/gitlab-org/gitlab-ce/issues?label_name%5B%5D=Accepting+Merge+Requests&label_name%5B%5D=UX&page=2&scope=all&state=opened/index.html.md).
...
Read about [__UX Department workflows__](https://github.com/isamu-isozaki/teamai_test/tree/master/engineering/ux/ux-department-workflow/index.html.md).
...
The [UX design archive](https://github.com/isamu-isozaki/teamai_test/tree/master/engineering/ux/design-archive/index.html.md) is a
...
The [UX research archive](https://github.com/isamu-isozaki/teamai_test/tree/master/engineering/ux/research-archive/index.html.md) is a
