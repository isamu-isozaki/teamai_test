...
| [Buyer](https://about.gitlab.com/handbook/marketing/product-marketing/#buyer-personas) | **Individual Contributors** | Engineering/Operations **Manager** | **Director** of DevOps/IT/Operations | **Chief** Architect, CIO, CTO, CISO, Chief Risk Officer |
...
1. Show customers the benefit of a [single application](/direction/#single-application). => This is essental since people are skeptical, showing beats telling.
