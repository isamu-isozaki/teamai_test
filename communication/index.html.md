...
For this, we use **asynchronous communication** and are as open as we can be by communicating through public issues, [chat channels](https://github.com/isamu-isozaki/teamai_test/tree/master/communication/chat/index.html.md),
...
Please see our [social media guidelines](https://github.com/isamu-isozaki/teamai_test/tree/master/marketing/social-media-guidelines/index.html.md/index.html.md).
...
1. Make a conscious effort to **prioritize** your work. The priority of items depends on multiple factors: Is someone waiting for the answer? What is the impact if you delay it? How many people does it affect, etc.? This is detailed in [Engineering Workflow](https://github.com/isamu-isozaki/teamai_test/tree/master/engineering/workflow/index.html.md).
...
1. Because we work globally, you may receive chat mentions at any time of day. Please consider enabling [Slack's Do not disturb functionality](https://github.com/isamu-isozaki/teamai_test/tree/master/tools-and-tips/#do-not-disturb-hours/index.html.md) so you don't get interrupted, for example, in your evenings.
...
1. Learn about [common channels and channel-naming conventions](https://github.com/isamu-isozaki/teamai_test/tree/master/communication/chat/index.html.md).
...
1. In our handbook, if you find yourself wondering whether it is better to provide a public link to a Google Doc vs. writing out the content on the website, use the following guideline: Is this document frequently adapted / customized? If yes, then provide a link, making sure that the document can be _commented on_ by _anyone_ with the link. For instance, this is how we share our employment [contracts](https://github.com/isamu-isozaki/teamai_test/tree/master/contracts/index.html.md/index.html.md). If the document is rarely customized, then provide the content directly on the site and deprecate the Google Doc.
...
1. After the general announcements, attendees share their personal interests by adding their name to the schedule or by discussing in a mixer call. The schedule is as follows:
  * Monday: Any topic
  * Tuesday: [Mixer Calls](https://github.com/isamu-isozaki/teamai_test/tree/master/communication/#mixer-calls/index.html.md), where we split off into smaller groups to discuss what we have been up to. No need to add yourself to the agenda on this day.
  ...
  * Thursday: [Mixer Calls](https://github.com/isamu-isozaki/teamai_test/tree/master/communication/#mixer-calls/index.html.md), where we split off into smaller groups to discuss what we have been up to. No need to add yourself to the agenda on this day.
  * Friday: Any topic
...
We split into small groups of around eight on Tuesdays and Thursday [Company Call](https://github.com/isamu-isozaki/teamai_test/tree/master/communication/#company-call/index.html.md), using Zoom's [Breakout Rooms](https://support.zoom.us/hc/en-us/articles/115005769646-Participating-in-Breakout-Rooms/index.html.md) feature. The groups are randomly assigned based on the participants in the Company Call.
...
1. Put your planned away time including holidays, vacation, travel time, and other leave in your own calendar. Please see [Communicating your time off](https://github.com/isamu-isozaki/teamai_test/tree/master/paid-time-off#communicating-your-time-off/index.html.md) for more.
...
1. For meetings that are scheduled with Zoom:
   ...
   1. If you need more privileges on Zoom (longer meeting times, more people in the meeting, etc./index.html.md), please contact People Ops as described [specifically for Zoom](https://github.com/isamu-isozaki/teamai_test/tree/master/tools-and-tips/#sts=Zoom/index.html.md).
...
1. Consider using a utility to easily mute/unmute yourself, see [Shush](https://github.com/isamu-isozaki/teamai_test/tree/master/tools-and-tips/#shush/index.html.md) in the tools section.
...
1. Do not use rich text, it makes it hard to copy/paste. Use [Markdown](https://github.com/isamu-isozaki/teamai_test/tree/master/product/technical-writing/markdown-guide/index.html.md) for things stored in git. In Google Docs use "Normal text" using the style/heading/formatting dropdown and paste without formatting.
...
1. We segment our customers/prospects into 4 segments [Strategic, Large, Mid-Market and Small Medium Business (SMB/index.html.md)](https://github.com/isamu-isozaki/teamai_test/tree/master/business-ops/#segmentation/index.html.md).
...
If you need to provide the details of GitLab's contact information you can take the [address from the visiting page](/visiting/index.html.md) for reference; or the [mailing address](https://github.com/isamu-isozaki/teamai_test/tree/master/people-operations/#addresses/index.html.md) of the office in the Netherlands if that is more applicable.
...
Make sure that domains don't overlap, for example [organization size](https://github.com/isamu-isozaki/teamai_test/tree/master/sales/#organization-size/index.html.md) and [deal size](https://github.com/isamu-isozaki/teamai_test/tree/master/sales/#deal-sizes/index.html.md) don't reuse words to prevent overlap.
If a term is ambiguous don't use it, for example our [hiring definitons](https://github.com/isamu-isozaki/teamai_test/tree/master/hiring/#definitions/index.html.md) have roles and vacancies but avoid the ambiguous word job.
Make sure that people can infer as much as possible from the word, for example our [subscription options](https://github.com/isamu-isozaki/teamai_test/tree/master/marketing/product-marketing/#tiers/index.html.md) allow you to know if someone if using self-managed or GitLab.com.
Make sure terms don't overlap without clearly defining how and why, for example see our [tier definitions](https://github.com/isamu-isozaki/teamai_test/tree/master/marketing/product-marketing/#definitions/index.html.md).
...
1. If you have a conversation that might be interesting please hit "record" (unless the [meeting is being livestreamed](https://github.com/isamu-isozaki/teamai_test/tree/master/communication/#live-streaming/index.html.md) already/index.html.md).
