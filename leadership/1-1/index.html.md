...
1. Make sure you use a consistent agenda format from week to week - reference
   the [suggested format](https://github.com/isamu-isozaki/teamai_test/tree/master/leadership/1-1/suggested-agenda-format/index.html.md) as
   necessary.
...
1. If you have few items on the agenda from the report try the following questions:
  ...
  - Have you identified any career development opportunities that I can help you with?
    - For example: [Interning for Learning](https://github.com/isamu-isozaki/teamai_test/tree/master/people-operations/promotions-transfers/#sts=Interning for Learning/index.html.md)
...
Once you have established the goals you can then create a [career development plan](https://github.com/isamu-isozaki/teamai_test/tree/master/people-operations/learning-and-development/#career-mapping-and-development/index.html.md)
