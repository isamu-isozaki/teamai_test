...
The following incentives are available for GitLabbers. Also see our separate page on [benefits](https://github.com/isamu-isozaki/teamai_test/tree/master/benefits/index.html.md/index.html.md) available to GitLabbers.
...
GitLabbers (not just the Sales team/index.html.md) for every month that we reach our IACV Targets. The incentive is [100 USD](https://github.com/isamu-isozaki/teamai_test/tree/master/people-operations/global-compensation/#exchange-rates/index.html.md)
...
- You should spend the incentive on eating out, and can be reimbursed _up to_ the maximum of [100 USD](https://github.com/isamu-isozaki/teamai_test/tree/master/people-operations/global-compensation/#exchange-rates/index.html.md).
...
1. For values based bonuses please see [Tinggly](https://github.com/isamu-isozaki/teamai_test/tree/master/incentives/#tinggly/index.html.md)
...
1. In a comment in the request in BambooHR, include _only_ the link to a google doc that details how the GitLabber demonstrated our [values](https://github.com/isamu-isozaki/teamai_test/tree/master/values/index.html.md). This doc should be comment-able to everyone at GitLab.
...
1. What are the different levels of experiences and how are they awarded?
  ...
  * Ultimate Collection (Valued at $279 USD/index.html.md): Awarded to the team member who is selected as the [Top Team Member](https://github.com/isamu-isozaki/teamai_test/tree/master/incentives/#top-team-member/index.html.md) each quarter.
  * Bucket List (Prices Vary/index.html.md): Bucket List items are reserved for Executive team nominations for extraordinary performance and alignment with our [values](https://github.com/isamu-isozaki/teamai_test/tree/master/values/index.html.md/index.html.md). The gift must be approved by the Chief Culture Officer and the CEO.
...
1. A Top Team Member (T2M/index.html.md) exemplifies the [GitLab Values](https://github.com/isamu-isozaki/teamai_test/tree/master/values/index.html.md/index.html.md) beyond of the [team of people](/team/structure/index.html.md/index.html.md) they directly work with.
1. Each quarter People Ops will request managers to nominate a team member who is not on their own team to receive the T2M award. All team members can submit nominations, but just ping your manager in the issue to upvote.
  ...
  * Nominations should focus on efforts and explain specific situations that represent any of our [values](https://github.com/isamu-isozaki/teamai_test/tree/master/values/index.html.md/index.html.md).
  * The T2M award will be announced on the [Company Call](https://github.com/isamu-isozaki/teamai_test/tree/master/communication/#company-call/index.html.md) to recognize the team member and posted on the culture page.
...
1. We want to encourage and support [diversity](https://github.com/isamu-isozaki/teamai_test/tree/master/values/index.html.md) and [frugality](https://github.com/isamu-isozaki/teamai_test/tree/master/values/index.html.md) on our team and in our hiring practices, so we will offer the following referral bonuses once the new team member has been with the company for 3 months.
    * Any great candidate that is referred and hired will earn a GitLab employee a [$1,000](https://github.com/isamu-isozaki/teamai_test/tree/master/people-operations/global-compensation/#exchange-rates/index.html.md) bonus once the new team member has been with the company for 3 months.
    * We will offer a [$1500](https://github.com/isamu-isozaki/teamai_test/tree/master/people-operations/global-compensation/#exchange-rates/index.html.md) referral bonus for hires from Rent Index less than 0.7.
    * We will offer a [$2000](https://github.com/isamu-isozaki/teamai_test/tree/master/people-operations/global-compensation/#exchange-rates/index.html.md) referral bonus for hires to teams with ["underrepresented groups"](http://seldo.com/weblog/2014/06/25/a_comparison_of_diversity_at_three_major_tech_companies/index.html.md). "Underrepresented groups" may refer to women, people of color, Hispanic/Latino people, veterans, or others, but it may also be defined differently from department to department and is subject to change as those departments grows more diverse. People Ops will confirm the bonus amount when it is entered into BambooHR.
...
* Please read about [how to make a referral](https://github.com/isamu-isozaki/teamai_test/tree/master/hiring/greenhouse/#making-a-referral/index.html.md) for more information.
